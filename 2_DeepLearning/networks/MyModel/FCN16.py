...
def FCN16(n_classes, input_height=496, input_width=512, vgg_level=3):
    ...
    # # Block 5
    # x = Conv2D(weights[4], (3, 3), activation='relu', padding='same', name='block5_conv1', data_format=IMAGE_ORDERING)(x)
    ...
    o = Conv2DTranspose(n_classes, kernel_size=(16, 16), strides=(16, 16), use_bias=False, data_format=IMAGE_ORDERING)(
        o)
